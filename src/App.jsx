...
function mapErrorMessage(err) {
  ...
  return "Could not read the prescription. Please try with a clearer image.";
}
...
export default function App() {
  ...
  async function handleScan(file) {
    ...
    try {
      const parsed = await interpretPrescriptionFromImage(file, language, setProgress, "");
          ...
          <div style={s.disclaimerBox}>
            ...
            <div>
              ...
              <p style={s.disclaimerText}>
                MediScan is an educational tool designed to help patients better understand their prescriptions. It is <strong>not a substitute for professional medical advice, diagnosis, or treatment.</strong> Always consult your pharmacist or physician with any questions about your medications.
              </p>
            </div>
          </div>
