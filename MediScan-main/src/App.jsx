...
const DEFAULT_API_KEY = "AIzaSyAksgo9plmCgrdRqIP6yAnwLrXycBCq27s";
...
export default function App() {
  ...
  async function handleScan(file) {
    ...
    try {
      const parsed = await interpretPrescriptionFromImage(file, language, setProgress, DEFAULT_API_KEY);
